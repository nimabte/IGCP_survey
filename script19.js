document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Synthetic samples/sample_12752/0_HQ_12752.jpg';
        ...
        const imageFiles = [
            '6_DR2_12752.jpg',
            '9_difface12752.png',
            '4_CodeFormer_12752.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_12752.jpg',
            '2_GFPGAN_12752.jpg',
            '5_VQFR_12752.jpg',
            '10_difbir12752.png',
            '3_GPEN_12752.jpg',
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_12752/${imageFiles[index]}`;
    ...
    if (nextBtn) {
        nextBtn.addEventListener('click', () => {
            ...
            localStorage.setItem('page_19_rankings', JSON.stringify(rankings));
            console.log('Saved page 19 rankings:', rankings);
