document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Synthetic samples/sample_3103/0_HQ_3103.jpg';
        ...
        const imageFiles = [
            '2_GFPGAN_3103.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_3103.jpg',
            '5_VQFR_3103.jpg',
            '9_difface3103.png',
            '3_GPEN_3103.jpg',
            '10_difbir3103.png',
            '4_CodeFormer_3103.jpg',
            '8_pgdiff_3103.jpg',
            '6_DR2_3103.jpg'
        ];
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_3103/${imageFiles[index]}`;
