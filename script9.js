document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        console.log('Starting to load images for page 9...');
        ...
        referenceImage.src = './Synthetic samples/sample_1259/0_HQ_1259.jpg';
        ...
        const imageFiles = [
            ...
            '8_pgdiff_1259.jpg',
            '5_VQFR_1259.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_1259.jpg',
            '10_difbir1259.png',
            '2_GFPGAN_1259.jpg',
            '6_DR2_1259.jpg',
            '4_CodeFormer_1259.jpg',
            '9_difface1259.png'
        ];
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_1259/${imageFiles[index]}`;
    ...
    nextBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('page_9_rankings', JSON.stringify(rankings));
        console.log('Saved page 9 rankings:', rankings);
