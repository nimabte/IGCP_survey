document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        console.log('Starting to load images for page 7...');
        ...
        referenceImage.src = './Synthetic samples/sample_1136/0_HQ_1136.jpg';
        ...
        const imageFiles = [
            ...
            '8_pgdiff_1136.jpg',
            '3_GPEN_1136.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_1136.jpg',
            '9_difface1136.png',
            '2_GFPGAN_1136.jpg',
            '10_difbir1136.png',
            '4_CodeFormer_1136.jpg',
            '6_DR2_1136.jpg'
        ];
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_1136/${imageFiles[index]}`;
    ...
    nextBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('page_7_rankings', JSON.stringify(rankings));
        console.log('Saved page 7 rankings:', rankings);
