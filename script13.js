document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        console.log('Starting to load images for page 13...');
        ...
        referenceImage.src = './Synthetic samples/sample_10186/0_HQ_10186.jpg';
        ...
        const imageFiles = [
            '4_CodeFormer_10186.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_10186.jpg',
            '9_difface10186.png',
            '2_GFPGAN_10186.jpg',
            '5_VQFR_10186.jpg',
            '10_difbir10186.png',
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_10186/${imageFiles[index]}`;
    ...
    nextBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('page_13_rankings', JSON.stringify(rankings));
        console.log('Saved page 13 rankings:', rankings);
