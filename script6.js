document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        console.log('Starting to load images for page 6...');
        ...
        referenceImage.src = './Synthetic samples/sample_1132/0_HQ_1132.jpg';
        ...
        const imageFiles = [
            '10_difbir1132.png',
            '4_CodeFormer_1132.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_1132.jpg',
            '2_GFPGAN_1132.jpg',
            '8_pgdiff_1132.jpg',
            '3_GPEN_1132.jpg',
            '5_VQFR_1132.jpg',
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_1132/${imageFiles[index]}`;
    ...
    nextBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('page_6_rankings', JSON.stringify(rankings));
        console.log('Saved page 6 rankings:', rankings);
