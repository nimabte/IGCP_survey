document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        const imageFiles = [
            ...
            '9_difface1084.png',
            '2_GFPGAN_1084.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_1084.jpg',
            '3_GPEN_1084.jpg',
            '10_difbir1084.png',
            '4_CodeFormer_1084.jpg',
            '8_pgdiff_1084.jpg',
            '6_DR2_1084.jpg'
        ];
    ...
    nextBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('page_2_rankings', JSON.stringify(rankings));
        console.log('Saved page 2 rankings:', rankings);
