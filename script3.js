document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Synthetic samples/sample_1088/0_HQ_1088.jpg';
        ...
        const imageFiles = [
            ...
            '3_GPEN_1088.jpg',
            '5_VQFR_1088.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_1088.jpg',
            '10_difbir1088.png',
            '2_GFPGAN_1088.jpg',
            '4_CodeFormer_1088.jpg',
            '6_DR2_1088.jpg',
            '9_difface1088.png'
        ];
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_1088/${imageFiles[index]}`;
