document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        console.log('Starting to load images for page 12...');
        ...
        referenceImage.src = './Synthetic samples/sample_4765/0_HQ_4765.jpg';
        ...
        const imageFiles = [
            '8_pgdiff_4765.jpg',
            '3_GPEN_4765.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_4765.jpg',
            '5_VQFR_4765.jpg',
            '10_difbir4765.png',
            '2_GFPGAN_4765.jpg',
            '6_DR2_4765.jpg',
            '4_CodeFormer_4765.jpg',
            '9_difface4765.png'
        ];
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_4765/${imageFiles[index]}`;
    ...
    nextBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('page_12_rankings', JSON.stringify(rankings));
        console.log('Saved page 12 rankings:', rankings);
