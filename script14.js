document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        console.log('Starting to load images for page 14...');
        ...
        referenceImage.src = './Synthetic samples/sample_10346/0_HQ_10346.jpg';
        ...
        const imageFiles = [
            ...
            '3_GPEN_10346.jpg',
            '9_difface10346.png',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_10346.jpg',
            '2_GFPGAN_10346.jpg',
            '10_difbir10346.png',
            '5_VQFR_10346.jpg',
            '4_CodeFormer_10346.jpg',
            '8_pgdiff_10346.jpg'
        ];
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_10346/${imageFiles[index]}`;
    ...
    nextBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('page_14_rankings', JSON.stringify(rankings));
        console.log('Saved page 14 rankings:', rankings);
