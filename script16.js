document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Synthetic samples/sample_11744/0_HQ_11744.jpg';
        ...
        const imageFiles = [
            ...
            '8_pgdiff_11744.jpg',
            '3_GPEN_11744.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_11744.jpg',
            '9_difface11744.png',
            '2_GFPGAN_11744.jpg',
            '10_difbir11744.png',
            '4_CodeFormer_11744.jpg',
            '6_DR2_11744.jpg'
        ];
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_11744/${imageFiles[index]}`;
