document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Synthetic samples/sample_1333/0_HQ_1333.jpg';
        ...
        const imageFiles = [
            '6_DR2_1333.jpg',
            '9_difface1333.png',
            '4_CodeFormer_1333.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_1333.jpg',
            '2_GFPGAN_1333.jpg',
            '5_VQFR_1333.jpg',
            '10_difbir1333.png',
            '3_GPEN_1333.jpg',
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_1333/${imageFiles[index]}`;
