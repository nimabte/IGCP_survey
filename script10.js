document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        console.log('Starting to load images for page 10...');
    ...
    nextBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('page_10_rankings', JSON.stringify(rankings));
        console.log('Saved page 10 rankings:', rankings);
