document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        console.log('Starting to load images for page 5...');
        ...
        referenceImage.src = './Synthetic samples/sample_1118/0_HQ_1118.jpg';
        ...
        const imageFiles = [
            ...
            '3_GPEN_1118.jpg',
            '9_difface1118.png',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_1118.jpg',
            '2_GFPGAN_1118.jpg',
            '10_difbir1118.png',
            '5_VQFR_1118.jpg',
            '4_CodeFormer_1118.jpg',
            '8_pgdiff_1118.jpg'
        ];
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_1118/${imageFiles[index]}`;
    ...
    nextBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('page_5_rankings', JSON.stringify(rankings));
        console.log('Saved page 5 rankings:', rankings);
