document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Synthetic samples/sample_10931/0_HQ_10931.jpg';
        ...
        const imageFiles = [
            '10_difbir10931.png',
            '4_CodeFormer_10931.jpg',
            '7_restored_faces_IGPN_new_ep39_vqgan_dec_15000_10931.jpg',
            '2_GFPGAN_10931.jpg',
            '8_pgdiff_10931.jpg',
            '3_GPEN_10931.jpg',
            '5_VQFR_10931.jpg',
        ...
        superResImages.forEach((img, index) => {
            if (index < imageFiles.length) {
                const imagePath = `./Synthetic samples/sample_10931/${imageFiles[index]}`;
